...
rule4 = ctrl.Rule(distance['very near'] & speed['stopped'], (brake['full'], throttle['slight']))
rule5 = ctrl.Rule(distance['very near'] & speed['very slow'], (brake['medium'], throttle['slight']))
rule6 = ctrl.Rule(distance['very near'] & speed['slow'], (brake['medium'], throttle['slight']))
